...
<head>
  ...
  <link href="../css/hyper.css?v=3.5" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css?family=Muli:300,400,500,600,700&display=swap" rel="stylesheet">
...
<body >
<div id="hyperLoadText"> Initializing api....</div>
  <div id="hyperLoad" >
  <?php
            ...
            <div class="uk-article-content">
              ...
              if ($hyper->get_parameter("limit", "reached")) {
                echo $hyper->create_notice_bar(
                  array(
                    "text" => "Limit reached (Dont check more than 2000)",
                    "css" => "text-warn",
                    "ele" => "p"
                  )
                );
              ...
              <div class="uk-form-stacked uk-margin-medium-top">
                ...
                <div class="uk-form-controls hyper_login">
                  <input class="hyper_input uk-input uk-border-rounded" id="skkey" placeholder="sk_live_xxxxxxxx" name="_subject" type="text">
                </div>
              </div> 
  ...
  <script src="../js/__inr.js?v=3.5"></script>
