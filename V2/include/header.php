	  ...
	  <div class="uk-container">
	    <div data-uk-navbar>
	      <div class="uk-navbar-left">
	        <a class="uk-navbar-item uk-logo uk-visible@m" href="https://t.me/K1NGX"><img src="../anonymousheader.svg" style='filter: invert(1); height: 30px; width: 30px; '>
        </a>
	      ...
	      <div class="uk-navbar-center uk-hidden@m">
	        <a class="uk-navbar-item uk-logo" href="https://t.me/K1NGX"><img src="../anonymousheader.svg" style='filter: invert(1); height: 30px; width: 30px; '></a>
	      </div>
	      <div class="uk-navbar-right">
	        <ul class="uk-navbar-nav uk-visible@m">
	          ...
	          <li>
	            ...
	            <?php } else { ?>
                    <a class="uk-button uk-button-small uk-button-primary-outline" href="./create?new_user=true">SIGN UP</a>
                    <?php } ?>
                </div>
	          </li>
	        </ul>
