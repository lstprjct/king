...
<head>
    ...
    <link rel="stylesheet" href="../css/hyper.css?v=2.7" />
          ...
          <div class="uk-article-content">
              <center>
               <p class="uk-text-lead uk-text-muted">
                 Do <a href="<?php echo $appconfig['bot_link']; ?>" class="access_link">/cmds</a> on bot to see commands</p>
              </center>
            
              <div class="uk-text-center">
                <a class="uk-button uk-button-primary uk-border-rounded" href="./?utm_source=usage" >
                Login to Realm's Checker!
          </a>
              </div>
          </div>
        </article>
